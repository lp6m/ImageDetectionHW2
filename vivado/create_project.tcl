...
set     design_bd_tcl_file  [file normalize [file join $root_directory "./vivado/create_bd.tcl"  ]]
set     design_pin_xdc_file [file normalize [file join $root_directory "./vivado/Ultra96_constraints_180318.xdc" ]]
lappend ip_repo_path_list   [file join $root_directory "hls"]
